...
function ClientConfirmation() {
    ...
    return(
        ...
        <div
        className="w-5/6 p-8 m-9 transition border border-gray-200 shadow-xl rounded-xl hover:shadow-blue-600/10 hover:border-blue-800/10"
        >
            <h1 className="text-xl md:text-4xl font-bold mb-4 md:m-10">Your information has been submitted!</h1>

            <div className="bg-stone-100 p-5 md:m-10 md:m-30 rounded-xl">
                <h3 className="text-xl m-2">Thank you for your interest in Blue Vest!</h3>
                <h3 className="text-lg">We look forward to working with you</h3>
                <h4 className="m-2 mt-10">Our representatives will reach out to you within 2 buisness days</h4>
            </div>
            <div className="m-10">
