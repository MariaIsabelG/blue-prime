                ...
                <div
                    ...
                    <div className="lg:gap-2 lg:pt-5 items-center justify-center ">
                        <div className="flex flex-col lg:flex-row lg:gap-2 items-center justify-center pt-10">
                            <div>
                                <label className="px-1 after:content-['*'] after:ml-0.5  after:text-red-500 text-sm lg:text-lg">First name</label>
                                <div className=''>
                                    <input
                                        required
                            ...
                            <div className=''>
                                <label className="px-1 after:content-['*'] after:ml-0.5 after:text-red-500 text-sm lg:text-lg">Last Name</label>
                                <div>
                                    <input
                                        required
                                        className="peer border rounded-sm hover:bg-white border-slate-400 bg-slate-100 px-1 shadow-sm"
                            ...
                            <div className=''>
                                <label className="px-1 text-sm lg:text-lg">Phone Number</label>
                                <div>
                                    <input
                                        className="border rounded-sm hover:bg-white border-slate-400 bg-slate-100 px-1 shadow-sm"
                        ...
                        <div className="flex flex-col lg:flex-row md:gap-2  lg:pt-5 items-center justify-center pl-5">
                            <div className=''>
                                <label className="px-1 after:content-['*'] after:ml-0.5 after:text-red-500 text-sm lg:text-lg">E-mail</label>
                                <div>
                                    <input
                                        required
                                        className="peer border rounded-sm hover:bg-white border-slate-400 bg-slate-100 px-1 shadow-sm"
                            ...
                            <div className=''>
                                <label className="px-1 after:content-['*'] after:ml-0.5 after:text-red-500 text-sm lg:text-lg">Zip Code</label>
                                <div>
                                    <input
                                        required
                                        className="peer border rounded-sm hover:bg-white border-slate-400 bg-slate-100 px-1 shadow-sm"
                            ...
                            <div className=''>
                                <label className="px-1 after:content-['*'] after:ml-0.5 after:text-red-500 text-sm lg:text-lg">State</label>
                                <div>
                                    ...
                                    <p className='invisible peer-invalid:visible text-red-700 font-thin text-xs lg:text-lg'>Please enter your zip code</p>
                        ...
                        <div className="flex flex-row md:gap-2 items-center justify-center pt-10">
                            <div className="justify-center">
                                <label className="px-1 after:content-['*'] after:ml-0.5  after:text-red-500 text-sm lg:text-lg">I am looking for...</label>
                                <div>
                                    <textarea
                                        rows="4"
                    ...
                    <div className="text-xl mb-6 text-center pt-7">
                        ...
                        <button
                            className="w-48 py-1 px-2 border border-transparent rounded-sm shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                            onClick={basicClient}>Submit Basic Information</button>
                    </div>
                </div>
            </div>
