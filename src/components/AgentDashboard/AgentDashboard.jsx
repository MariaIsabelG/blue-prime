...
return(
    <div>
        ...
        <ul class=" text-sm font-medium text-center text-gray-500 rounded-lg divide-x divide-gray-200 shadow sm:flex dark:divide-gray-700 dark:text-gray-400">
            ...
            <li class="w-full">
                <a onClick={() => history.push('/agent/potentials')} className="inline-block p-4 w-full bg-gray-100 hover:text-gray-700 hover:bg-gray-50 focus:ring-4 focus:ring-blue-300 focus:outline-none dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700"
                >Potential</a>
            </li>
            <li class="w-full">
                <a onClick={() => history.push('/agent/won')} className="inline-block p-4 w-full bg-gray-100 hover:text-gray-700 hover:bg-gray-50 focus:ring-4 focus:ring-blue-300 focus:outline-none dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700"
                >Won</a>
            </li>
            <li class="w-full">
                <a onClick={() => history.push('/agent/lost')} className="inline-block p-4 w-full bg-gray-100 rounded-r-lg hover:text-gray-700 hover:bg-gray-50 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700"
                >Lost</a>
            </li>
        </ul>
