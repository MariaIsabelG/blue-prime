                ...
                <div className='sm:flex md:flex bg-white'>
					<div className="sm:static md:static lg:pl-36 xl:mt-10 ">
						<div className='px-10 text-4xl text-gray-900 sm:mt-24 md:mt-24 lg:mt-30 lg:text-7xl xl:mt-16 xl:7xl '>
							...
							<li className='mt-10 text-xl text-gray-500'>Where your time and financial needs are valued.</li>
						...
						<div className="flex mt-8">
                            ...
                            <div onClick={() => history.push('/resources')} className='flex items-center justify-center inline-block border-2 rounded-lg bg-orange-400 px-2 text-white font-bold hover:shadow-lg hover:bg-orange-600 mb-10 mt-8 mr-2 text-lg h-12 sm:h-16 sm:w-36 md:w-40 lg:w-44 xl:w-48 xl:text-2xl' >
                                Resources 
                            </div>
                            <div onClick={() => history.push('/about')} className='flex items-center justify-center inline-block border-2 rounded-lg bg-blue-400 px-2 text-white text-center font-bold hover:shadow-lg hover:bg-blue-700 mb-10 mt-8 mr-3 text-md h-12 sm:h-16 sm:w-36 md:w-40 lg:w-44 xl:w-44 xl:text-2xl'>
                                About us!
                            </div>
						</div>
					</div>
