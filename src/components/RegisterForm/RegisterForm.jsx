		...
		<div className='max-w-screen-md h-full px-4 py-16 mx-auto sm:px-6 lg:px-8 sm:py-0 flex items-center justify-center'>
			<form className=' md:mt-20 border bg-stone-100 md:w-8/12 ' onSubmit={registerUser}>
				...
				<div className='items-center justify-center '>
					<h3 className='text-2xl text-black text-center font-bold sm:text-1xl px-6 mb-5 '>
						Welcome to the BlueVest team!
					</h3>
				</div>
				...
				<div className='text-left sm:text-1xl p-6 lg:py-0 bg-blue-600 border rounded-b-xl '>
					...
					<div className='flex items-center justify-center absolute'>
						<div className='text-white mt-5'>
							<button type='button'>Select States of Licensure</button>
							<div>
								<input
									type='text'
									value={search}
								...
								{states
									...
									.map((state) => (
										<ul>
											<li
												className='bg-gray-100 hover:bg-gray-300 px-2 border text-black'
												type='button'
							...
							return (
								<div className='mt-1'>
									...
									<button
										...
										type='button'
										onClick={() => removeState(agentstate)}>
										✖️
									</button>
								</div>
							);
