            ...
            <div className="bg-white border-2 border-r-black pt-10 lg:pt-20 w-full pb-10 lg:w-6/12">
                ...
                <div className=" flex justify-center items-center">
                    <div className=" text-sm lg:text-xl w-64 lg:w-5/6 text-center text-black">
                        ...
                        <li className="py-2 text-sm list-none italic ">Simplify the process by importing your current insurance information through Canopy. Our professionals can get straight to work using this information to compare rates and give you the best pricing</li>
                        <a href="https://usecanopy.com/" className="text-xs text-slate-600 underline underline-offset-4 italic hover:text-blue-600">To find out more about Canopy please click here</a>
