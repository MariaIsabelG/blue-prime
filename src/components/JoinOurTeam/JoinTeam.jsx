    ...
    return (
        <section class="h-full">
            <div className="px-18 sm:px-20 sm:pt-10 sm:pb-10 md:pt-10 md:pb-10 lg:pt-8 lg:pb-2 pb-10 pt-10 bg-orange-200 mb-2">
                <h3 className="text-3xl text-black text-center font-bold sm:text-1xl p-6">Why work with us? </h3>
                ...
                <h3 className="text-xl text-center text-black mt-6 mb-6 mx-6 lg:mb-6">BlueVest has helped some of the biggest names in financial services grow their brand and practice.</h3>
                ...
                <div className="flex xl:justify-center lg:justify-between justify-center items-center flex-wrap h-full g-6">
                    ...
                    <div className="xl:ml-20 xl:w-5/12 lg:w-5/12 md:w-8/12 mb-5 md:mb-0">
                        <div className=" md:pt-32 sm:pt-10 sm:pb-10 md:pt-10 md:pb-10 lg:pt-8 lg:pb-8 pb-2 pt-10 bg-white ">
                            <h3 className="text-3xl text-black text-center font-bold sm:text-1xl p-6">What you can Expect when you Sign Up:</h3>
                            <li className="text-center text-black mb-4">BlueVest's team is your partner to grow your business. Upon signing up for BlueVest Pro, you'll be introduced to a personal Account Manager that will help you establish a game plan, provide strategic advice, maximize ROI, and develop a custom roadmap based on your specific business needs and budget.</li>
                            <li className="text-center text-black mb-4">We're committed to providing you with high-quality consumer prospects, account flexibility and excellent customer service.</li>
                        </div>
                        <div className="flex items-center justify-center ">
                            <a href="https://calendly.com/mitchell-muller/30min?month=2022-09">
                            <button className="text-lg text-white text-center font-bold sm:text-1xl p-6 bg-blue-600 border rounded-xl">Schedule an Intro Meeting!</button>
                            </a>
                        </div>
                    </div>
                </div>
