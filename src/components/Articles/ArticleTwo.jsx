                ...
                <div className="text-lg lg:text-xl">
                    <section className="mt-10 flex flex-col lg:text-lg">
                        <article>
                            ...
                            <br></br>
                            <p>How to get car insurance in 5 easy steps:</p>
                            ...
                            <p>While there are a few ways to get car insurance, the best and most efficient way to
                    ...
                    <section>
                        <article>
                            ...
                            <br></br>
                            <p><span className="font-bold">A typical full-coverage policy includes:</span></p>
                            ...
                            <br></br>
                            <p>Most insurers offer additional coverage options, like roadside assistance or new car
                    ...
                    <section>
                        <article>
                            <p>2. Fill out an insurance application:
                            ...
                            <br></br>
                            <p>As you go through the application process, your answers to certain questions may
                    ...
                    <section>
                        <article>
                            <p>3. Compare different auto insurance quotes:
