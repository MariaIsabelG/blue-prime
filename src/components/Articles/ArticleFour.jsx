    ...
    return (
        <div>
            <div className="h-full mt-20 mr-20 ml-20">
                <h1 className=" text-2xl lg:text-4xl font-bold capitalize">What does renters insurance cover?</h1>
...
<br />
                            <p>Renters insurance is financial protection for a tenant and their personal belongings.
                            ...
                            <br />
                            <p>Renters insurance is made up of three different categories of coverage. Each
                    ...
                    <section>
                        <article>
                            ...
                            <br />
                            <p>A renters insurance policy will cover costs to replace your personal
                            ...
                            <br />
                            <p>Renters insurance can also cover property when it’s not even in your home,
                    ...
                    <section>
                        <article>
                            ...
                            <br />
                            <p>If your residence has been made uninhabitable, renters insurance can also
                            ...
                            <p>Otherwise known as additional living expenses, this part of your renters
                    ...
                    <section>
                        <article>
                            ...
                            <br />
                            <p>There are circumstances when renters insurance will not cover your personal
                    ...
                    <section>
                        <article>
                            ...
                            <br />
                            <p>If some of your belongings exceed your policy’s limits or sublimits, you can
                    ...
                    <section>
                        <article>
                            ...
                            <br />
                            <p>Take an inventory of everything you own and add it all up. The average
                            ...
                            <br />
                            <p>There are two types of renters insurance policies you can choose from, and
...
<br />
                            ...
                            <br />
                            <p>In addition to choosing between an actual cash value or replacement cost
                            ...
                            <br />
                            <p>You should talk to your insurance company to decide which policy works best
