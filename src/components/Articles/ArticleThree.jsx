    ...
    return (
        <div>
            <div className="h-full mt-20 mr-20 ml-20">
                <h1 className=" text-2xl lg:text-4xl font-bold capitalize">Guide to Long-Term Disability Insurance</h1>
                <div className="text-lg lg:text-xl">
                    ...
                    <section>
                        <article>
                            <h2 className="text-xl lg:text-2xl font-bold">What is disability insurance?</h2>
                            <br />
                            ...
                            <br />
                            <p>All insurance policies include a definition of disability, which explains the
                    ...
                    <section>
                        <article>
                            <h1 className="text-xl lg:text-2xl font-bold">How long-term disability insurance works</h1>
                            <br />
                            ...
                            <br />
                            <h2 className="text-lg lg:text-xl font-bold">Long-term disability insurance benefits</h2>
                            <p>
                            ...
                            <br />
                            <p>Your long-term disability benefits usually aren’t taxable (unlike short-term
                            ...
                            <br />
                            <h2 className="text-lg lg:text-xl font-bold">Do you need long-term disability insurance?</h2>
                            <br />
                            <p>If you can’t go years or months without a paycheck without depleting your
                            ...
                            <br />
                            <p>Disability insurance isn’t just for people who work dangerous jobs. You can
                            ...
                            <br />
                            <p>Long-term disability insurance protects your most valuable asset — your
...
<br />
                            <p>The application process takes about four to six weeks to complete. There are
                            ...
                            <br />
                            <p>A licensed agent at BlueVest can help you get a disability quote and find a long-
                                term policy that meets your needs.</p>
                                <br />
                            <h2 className="text-lg lg:text-xl font-bold">How much does disability insurance cost?</h2>
                            <br />
                            <p>You can generally expect to pay between 1% to 3% of your annual salary for
